-- ============================================
-- LUMA — Repagination Oz Tome 1 : pages plus denses
-- ============================================


delete from book_pages where book_id = (
  select id from books where title = 'Tome 1 : Le Cyclone'
  and series_id = (select id from books where title = 'The Wonderful Wizard of Oz' and is_series = true)
);
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 2, '[{"en": "When Dorothy stood in the doorway and looked around, she could see nothing but the great gray prairie on every side.", "fr": "Quand Dorothy se tenait dans l''embrasure de la porte et regardait autour d''elle, elle ne voyait rien d''autre que la grande prairie grise de tous les côtés."}, {"en": "Not a tree nor a house broke the broad sweep of flat country that reached to the edge of the sky in all directions.", "fr": "Pas un arbre ni une maison ne brisait la vaste étendue de pays plat qui atteignait le bord du ciel dans toutes les directions."}, {"en": "When Aunt Em came there to live she was a young, pretty wife. The sun and wind had changed her, too.", "fr": "Quand Tante Em était venue vivre là, c''était une jeune et jolie épouse. Le soleil et le vent l''avaient changée, elle aussi."}, {"en": "She was thin and gaunt, and never smiled now.", "fr": "Elle était mince et décharnée, et ne souriait plus jamais."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 3, '[{"en": "Uncle Henry never laughed. He worked hard from morning till night and did not know what joy was.", "fr": "Oncle Henry ne riait jamais. Il travaillait dur du matin au soir et ne savait pas ce qu''était la joie."}, {"en": "It was Toto that made Dorothy laugh, and saved her from growing as gray as her other surroundings.", "fr": "C''était Toto qui faisait rire Dorothy, et qui l''empêchait de devenir aussi grise que tout ce qui l''entourait."}, {"en": "Today, however, they were not playing. Uncle Henry sat upon the doorstep and looked anxiously at the sky, which was even grayer than usual.", "fr": "Aujourd''hui, cependant, ils ne jouaient pas. Oncle Henry était assis sur le pas de la porte et regardait anxieusement le ciel, encore plus gris que d''habitude."}, {"en": "From the far north they heard a low wail of the wind, and Uncle Henry and Dorothy could see where the long grass bowed in waves before the coming storm.", "fr": "Du grand nord, ils entendaient un faible gémissement du vent, et Oncle Henry et Dorothy pouvaient voir l''herbe haute plier en vagues devant la tempête qui approchait."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 5, '[{"en": "Then a strange thing happened. The house whirled around two or three times and rose slowly through the air.", "fr": "Puis une chose étrange se produisit. La maison tourbillonna deux ou trois fois et s''éleva lentement dans les airs."}, {"en": "Dorothy felt as if she were going up in a balloon.", "fr": "Dorothy avait l''impression de monter dans un ballon."}, {"en": "It was very dark, and the wind howled horribly around her, but Dorothy found she was riding quite easily.", "fr": "Il faisait très sombre, et le vent hurlait horriblement autour d''elle, mais Dorothy trouvait qu''elle voyageait plutôt facilement."}, {"en": "Toto did not like it. He ran about the room, now here, now there, barking loudly.", "fr": "Toto n''aimait pas ça. Il courait dans la pièce, tantôt ici, tantôt là, en aboyant fort."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 6, '[{"en": "Once Toto got too near the open trap door, and fell in; and at first the little girl thought she had lost him.", "fr": "Une fois, Toto s''approcha trop de la trappe ouverte, et tomba dedans ; d''abord, la fillette crut l''avoir perdu."}, {"en": "She crept to the hole, caught Toto by the ear, and dragged him into the room again.", "fr": "Elle rampa jusqu''au trou, attrapa Toto par l''oreille, et le tira à nouveau dans la pièce."}, {"en": "In spite of the swaying of the house and the wailing of the wind, Dorothy soon closed her eyes and fell fast asleep.", "fr": "Malgré le balancement de la maison et le gémissement du vent, Dorothy ferma bientôt les yeux et s''endormit profondément."}, {"en": "She was awakened by a shock, so sudden and severe that if Dorothy had not been lying on the soft bed she might have been hurt.", "fr": "Elle fut réveillée par un choc, si soudain et si violent que si Dorothy n''avait pas été allongée sur le lit moelleux, elle aurait pu se blesser."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 8, '[{"en": "Banks of gorgeous flowers were on every hand, and birds with rare and brilliant plumage sang and fluttered in the trees.", "fr": "Des massifs de fleurs magnifiques se trouvaient de tous côtés, et des oiseaux au plumage rare et éclatant chantaient et voletaient dans les arbres."}, {"en": "While she stood looking eagerly at the strange and beautiful sights, she noticed coming toward her a group of the queerest people she had ever seen.", "fr": "Alors qu''elle regardait avec impatience ces vues étranges et magnifiques, elle remarqua venir vers elle un groupe des gens les plus étranges qu''elle ait jamais vus."}, {"en": "They were not as big as the grown folk she had always been used to; but neither were they very small.", "fr": "Ils n''étaient pas aussi grands que les adultes auxquels elle était habituée ; mais ils n''étaient pas très petits non plus."}, {"en": "Three were men and one a woman, and all were oddly dressed. They wore round hats that rose to a small point a foot above their heads.", "fr": "Trois étaient des hommes et une était une femme, et tous étaient étrangement habillés. Ils portaient des chapeaux ronds qui s''élevaient en une petite pointe au-dessus de leur tête."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 9, '[{"en": "The little woman walked up to Dorothy, made a low bow and said, in a sweet voice: ''You are welcome, most noble Sorceress, to the land of the Munchkins.''", "fr": "La petite femme s''approcha de Dorothy, fit une profonde révérence et dit, d''une voix douce : ''Soyez la bienvenue, noble Sorcière, au pays des Munchkins.''"}, {"en": "''We are so grateful to you for having killed the Wicked Witch of the East, and for setting our people free from bondage.''", "fr": "''Nous vous sommes tellement reconnaissants d''avoir tué la Méchante Sorcière de l''Est, et d''avoir libéré notre peuple de l''esclavage.''"}, {"en": "Dorothy listened to this speech with wonder. She had never killed anything in all her life.", "fr": "Dorothy écouta ce discours avec étonnement. Elle n''avait jamais tué quoi que ce soit de toute sa vie."}, {"en": "''You are very kind, but there must be some mistake. I have not killed anything,'' Dorothy said, with hesitation.", "fr": "''Vous êtes très aimable, mais il doit y avoir une erreur. Je n''ai rien tué,'' dit Dorothy, avec hésitation."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 10, '[{"en": "''Your house did, anyway,'' replied the little old woman, with a laugh. ''There are her two feet, still sticking out from under a block of wood.''", "fr": "''Votre maison si, en tout cas,'' répondit la petite vieille femme, en riant. ''Voilà ses deux pieds, qui dépassent encore de sous un bloc de bois.''"}, {"en": "Dorothy looked, and gave a little cry of fright. There, indeed, two feet were sticking out, shod in silver shoes with pointed toes.", "fr": "Dorothy regarda, et poussa un petit cri de frayeur. Là, en effet, deux pieds dépassaient, chaussés de souliers d''argent aux bouts pointus."}, {"en": "''She was the Wicked Witch of the East,'' answered the little woman. ''She has held all the Munchkins in bondage for many years.''", "fr": "''C''était la Méchante Sorcière de l''Est,'' répondit la petite femme. ''Elle a tenu tous les Munchkins en esclavage pendant de nombreuses années.''"}, {"en": "''Are you a real witch?'' Dorothy cried. ''Yes, indeed,'' answered the little woman. ''But I am a good witch, and the people love me.''", "fr": "''Êtes-vous une vraie sorcière ?'' s''écria Dorothy. ''Oui, en effet,'' répondit la petite femme. ''Mais je suis une bonne sorcière, et le peuple m''aime.''"}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 12, '[{"en": "Dorothy began to sob at this, for she felt lonely among all these strange people. The little old woman took off her cap, balanced it on her nose, and counted ''One, two, three'' in a solemn voice.", "fr": "Dorothy se mit à sangloter à cela, car elle se sentait seule parmi tous ces gens étranges. La petite vieille femme retira son bonnet, l''équilibra sur son nez, et compta ''Un, deux, trois'' d''une voix solennelle."}, {"en": "At once the cap changed to a slate, on which was written: ''LET DOROTHY GO TO THE CITY OF EMERALDS.''", "fr": "Aussitôt le bonnet se changea en ardoise, sur laquelle était écrit : ''QUE DOROTHY ALLE À LA CITÉ DES ÉMERAUDES.''"}, {"en": "''The road to the City of Emeralds is paved with yellow brick,'' said the Witch, ''so you cannot miss it.''", "fr": "''La route vers la Cité des Émeraudes est pavée de briques jaunes,'' dit la Sorcière, ''donc vous ne pouvez pas la manquer.''"}, {"en": "She came close to Dorothy and kissed her gently on the forehead, leaving a round, shining mark.", "fr": "Elle s''approcha de Dorothy et l''embrassa doucement sur le front, laissant une marque ronde et brillante."}]'::jsonb from b;
...
insert into book_pages (book_id, page_number, sentences)
select b.id, 13, '[{"en": "When Dorothy was left alone she began to feel hungry. So she went to the cupboard and cut herself some bread, which she spread with butter.", "fr": "Quand Dorothy fut laissée seule, elle commença à avoir faim. Alors elle alla au placard et se coupa du pain, qu''elle tartina de beurre."}, {"en": "She gave some to Toto, and taking a pail from the shelf she carried it down to the little brook and filled it with clear, sparkling water.", "fr": "Elle en donna à Toto, et prenant un seau sur l''étagère, elle le porta jusqu''au petit ruisseau et le remplit d''eau claire et scintillante."}, {"en": "Dorothy had only one other dress, but that happened to be clean and was hanging on a peg beside her bed. It was gingham, with checks of white and blue.", "fr": "Dorothy n''avait qu''une seule autre robe, mais elle était justement propre et suspendue à un crochet près de son lit. C''était du vichy, à carreaux blancs et bleus."}, {"en": "She took a little basket and filled it with bread from the cupboard, laying a white cloth over the top.", "fr": "Elle prit un petit panier et le remplit de pain du placard, posant un linge blanc par-dessus."}]'::jsonb from b;

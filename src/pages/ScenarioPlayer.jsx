...
function ScenarioPlayer() {
  ...
  const chooseOption = async (choice) => {
    ...
    const newHistory = [...history, { speaker: node.speaker, text: node.text, text_fr: node.text_fr, chosenReply: choice.text }]
    ...
    if (nextNode.end) {
      ...
      // Sauvegarde la progression pour pouvoir reprendre plus tard.

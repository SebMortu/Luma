...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 1)
  and position = 7;
...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 2)
  and position = 6;
...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 3)
  and position = 6;
...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 4)
  and position = 5;
...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 5)
  and position = 6;
...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 6)
  and position = 7;
...
where unit_id = (select id from units join languages on languages.id = units.language_id where languages.code = 'en' and units.position = 7)
  and position = 7;
